...
namespace App\Models\Definition\Catalog\Category\Subs\CategoryTranslation;
...
trait CategoryTranslationField
{
    ...
    #[FormField(type: 'modal', required: true, relationship: ['type' => 'category', 'route' => 'definition/catalog/category', 'fields' => ['id' => 'category_id', 'label' => 'name']], sort_order: 5)]
    #[TableColumn(['showing', 'filtering', 'sorting'])]
    #[ActionType(['index', 'show', 'store', 'update'])]
